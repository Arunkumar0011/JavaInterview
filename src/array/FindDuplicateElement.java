...
public class FindDuplicateElement {
	...
	HashSet<String> UniqueElemnts = new HashSet<String>();
	HashSet<String> duplicate = new HashSet<String>();
	
	for (String nameStr : name) {
		
		if(!UniqueElemnts.contains(nameStr)) {
			UniqueElemnts.add(nameStr);
		}
		else {
	...
	System.out.println("Duplicate Elemenet  " + UniqueElemnts);
